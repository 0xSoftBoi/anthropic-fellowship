// Allbridge Core Pool (BUSD/vUSD) — verified source, BSC (via Sourcify)
// Address: 0x179aaD597399B9ae078acFE2B746C09117799ca0
// Exploit 2023-04-01 (~$570K): flash-loaned BUSD used to act as LP + swapper, manipulating the
// pool's internal price (swap/withdraw math) to over-withdraw. spot-price dependency.
