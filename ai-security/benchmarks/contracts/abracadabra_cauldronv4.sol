// Abracadabra PrivilegedCheckpointCauldronV4 (impl behind cauldron proxies) — verified, Ethereum
// Address: 0x5E70F7AcB8ec0231c00220d11c74dC2B23187103
// Exploit 2025-10-04 (~$1.8M): cook() actions [5,0] — BORROW sets needsSolvencyCheck=true, then
// action 0's empty else-branch reset it false, skipping the final solvency check (uncollateralized borrow).

// ===== FILE: src/cauldrons/PrivilegedCheckpointCauldronV4.sol =====
...
// ===== FILE: src/cauldrons/PrivilegedCauldronV4.sol =====
// SPDX-License-Identifier: UNLICENSED
pragma solidity >=0.8.0;
...
// ===== FILE: src/interfaces/ICheckpointToken.sol =====
// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0;
...
// ===== FILE: src/interfaces/ISwapperV2.sol =====
// SPDX-License-Identifier: MIT
pragma solidity >=0.8.0;
